...
-- suspension script enable

sus.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet("https://raw.githubusercontent.com/YzSMG/BoNaif-s-Greenville-vehicle-control-script/refs/heads/main/main.lua"))()
end)
