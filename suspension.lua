...
local closeBtn = createTopBtn("X", Color3.fromRGB(180, 40, 40), -45)
local transBtn = createTopBtn("AR", Color3.fromRGB(40, 40, 40), -95)
local minBtn = createTopBtn("-", Color3.fromRGB(40, 40, 40), -135)
